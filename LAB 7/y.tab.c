...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_dlist = 10,                     /* dlist  */
  YYSYMBOL_D = 11,                         /* D  */
  YYSYMBOL_idlist = 12,                    /* idlist  */
  YYSYMBOL_T = 13                          /* T  */
};
...
static const char *const yytname[] =
{
  ...
  "CHAR", "COMMA", "SEMICOLON", "$accept", "dlist", "D", "idlist", "T", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* D: T idlist SEMICOLON  */
#line 75 "declbasic2.y"
    {
        int n;
        char** arr = list_to_array((yyvsp[-1].list), &n);
        append_list(arr, n, curr_type, curr_size);
    }
#line 1186 "y.tab.c"
    break;

  case 5: /* idlist: idlist COMMA ID  */
#line 83 "declbasic2.y"
       {
           (yyval.list) = append_node((yyvsp[-2].list), (yyvsp[0].str));
       }
#line 1194 "y.tab.c"
    break;

  case 6: /* idlist: ID  */
#line 87 "declbasic2.y"
       {
           (yyval.list) = create_node((yyvsp[0].str));
       }
#line 1202 "y.tab.c"
    break;

  case 7: /* T: INT  */
#line 93 "declbasic2.y"
    {
