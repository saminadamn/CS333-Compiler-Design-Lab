...
# testprogcopy.c:8:   { for (int i = 0 ; i < 10000; i++)
	addq	$1, %rcx	#, ivtmp.20
	cmpq	$10000, %rcx	#, ivtmp.20
	jne	.L4	#,
# testprogcopy.c:7:   for ( int k = 0;  k < 100; k++) 
	subl	$1, %edi	#, ivtmp_10
	jne	.L2	#,
# testprogcopy.c:17:   index1 = rand()%10000;
	call	rand@PLT	#
# testprogcopy.c:17:   index1 = rand()%10000;
...
# testprogcopy.c:18:   index2 = rand()%10000;
	call	rand@PLT	#
...
# testprogcopy.c:19:   printf(" %d %d %d %d \n", index1, a[index1], index2, b[index2]); 
