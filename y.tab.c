...
S   : IF '(' B ')' {
        ...
        print($3.truelist);
        display(out_file, $3.truelist);
        
        printf("\nFalselist after processing ");
        fprintf(out_file, "\nFalselist after processing ");
        print($3.falselist);
        display(out_file, $3.falselist);
        
        printf("\n");
        fprintf(out_file, "\n");
      } M THEN Assign N ELSE M Assign {
        backpatch(out_file, $3.truelist, $6);
        backpatch(out_file, $3.falselist, $11);
        backpatch(out_file, $9, nextinstr);
      }
    ;
